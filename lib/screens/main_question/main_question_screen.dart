...
import 'package:csacademy/screens/main_question/question_card.dart';
...
class MainQuestionScreen extends GetView<MyZoomDrawerController> {
  const MainQuestionScreen({super.key});

  static const String routeName = "/mainquestionscreen";
